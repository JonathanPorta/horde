...
public class Weapon : System.Object {
    ...
    public float damage = 10.0f; // Health points of damage caused by a single firing - indepenent of where it hits the other. (for now.)
    public float fireRate = 1.0f; // Seconds requird between each firing.
