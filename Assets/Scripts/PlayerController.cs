...
public class PlayerController : MonoBehaviour {
  ...
  // For counting kills
  public delegate void KillDelegate(EnemyController ec);
  KillDelegate killDelegate;
  ...
  void Kill(EnemyController ec) {
    gameManager.Kill(this, ec);
  }
...
public class PlayerState : System.Object {
  ...
  public bool isAlive = false; // That's right, you start out dead. Deal with it!
}